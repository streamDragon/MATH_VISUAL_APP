...
const QUESTIONS = [
  {
    ...
    desc:
      "לפני התרגול בוחרים משפחת פונקציות שממנה אפשר לראות את השאלה בצורה ברורה.\n" +
      "אחרי הבחירה בונים גרף פתיחה, ואז עוברים לעריכת פרמטרים כדי להפיק ממנו תנאים ומשוואות.",
    mode: "setup",
  ...
  },
  {
    ...
    steps: [
      {
        instruction: "מומלץ לבחור line, לטעון גרף פתיחה, ולבנות מהנקודה (2,0) את התנאי f(2)=0 במחברת.",
        goal: {
          type: "hit_target",
          params: {
            targets: [{ x: 2, y: 0, label: "B" }],
