  ...
  },
  {
    ...
    overlay: {
      ...
      howTo: [
        ...
        "אפשר ללחוץ על \"טען תצורה מומלצת לשאלה\" כדי להתחיל מתצורה שמבליטה את הרמז החשוב.",
    ...
    steps: [
      {
        instruction: "מומלץ לבחור line, לטעון תצורה מומלצת, ולבנות מהנקודה (2,0) את התנאי f(2)=0 במחברת.",
        goal: {
          type: "hit_target",
          params: {
            targets: [{ x: 2, y: 0, label: "B" }],
